...
public class MyBattleGUI : BattleGUI {
	...
	public class WonRoundsGUI {
		...
		public MyBattleGUI.VisibleImages VisibleImages = MyBattleGUI.VisibleImages.WonRounds;
	...
	protected override void OnGameBegin(ControlsScript cPlayer1, ControlsScript cPlayer2, StageOptions stage) {
		...
		else if (this.wonRounds.LostRounds == null && this.wonRounds.VisibleImages == MyBattleGUI.VisibleImages.AllRounds) {
	...
	protected override void OnRoundEnd(ControlsScript winner, ControlsScript loser) {
		...
		if (this.wonRounds.NotFinishedRounds == null) {
			...
			if (this.wonRounds.VisibleImages == MyBattleGUI.VisibleImages.AllRounds) {
		...
		// Show the number of rounds won
		winnerGUI.roundCount.text = winner.roundsWon.ToString();
		loserGUI.roundCount.text = loser.roundsWon.ToString();
